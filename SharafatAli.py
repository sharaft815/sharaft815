...
name = raw_input ("\033[91mAp ka Nama ?(SharafatAliName Real) : ")																	

																	

if name == (""):																	

     print '\x1b[1;92mReal Nama istmal karain SharafatAli :V'																	
...
if password == ("03104693783"):																	
     ...
     print 'Welcome ' + name + ' SharafatAli'																	

     time.sleep(0.8)																	

     print 'Semoga beruntung ' + name + ' SharafatAli'																	
     ...
     print 'SharafatAli ' + name + ' Agar Facebook  tools Galat ho gaya  <https://www.facebook.com/SHARFAT.TERABAAP06>'																	
     ...
     print ("Ap ka Darj kia Gia password Galat ha SharafatAli sy help lain (+923104693783)")																	
